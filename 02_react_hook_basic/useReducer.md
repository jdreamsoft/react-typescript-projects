...
If you find yourself keeping track of multiple pieces of state that rely on complex logic, useReducer may be useful.<br />
...
The useReducer Hook returns the current state and a dispatchmethod.<br />

## Example: Here is an example of useReducer in a counter app
This is just the logic to keep track of the todo complete status. <br />
